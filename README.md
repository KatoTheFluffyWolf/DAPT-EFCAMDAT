...
5. **Proficiency-based ablation**  
   BERT, RoBERTa, and DistilBERT are further pretrained on selected CEFR-based EFCAMDAT subsets, such as A1–A2, B1–B2, and B2–C1, to test whether better-aligned pretraining data improves downstream AES performance.
